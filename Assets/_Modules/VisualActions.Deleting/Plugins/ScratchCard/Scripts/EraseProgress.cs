using Mimi.ScratchCardAsset.Tools;
using UnityEngine;
...
namespace Mimi.ScratchCardAsset
{
    public class EraseProgress : MonoBehaviour
    {
        ...
        {
            scratchMode = this.Card.Mode;
            currentProgress = scratchMode == ScratchCard.ScratchMode.Erase ? 0f : 1f;
            isCompleted = false;
